        ...
        <div className="lg:hidden">
            ...
            <header className="sticky top-0 z-40 flex items-center justify-between border-b bg-card/95 backdrop-blur-md px-4 py-3 shadow-sm pt-safe">
                ...
                <button
                    ...
                    className="p-2.5 -mr-1 text-muted-foreground hover:text-foreground transition-colors active:scale-95"
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed inset-y-0 left-0 z-50 w-[min(300px,85vw)] bg-card shadow-2xl"
                        >
                            <div className="absolute right-3 top-3 z-10">
                                <button
                                    onClick={() => setIsOpen(false)}
                                    className="p-2.5 text-muted-foreground hover:text-foreground active:scale-95 transition-all rounded-lg hover:bg-white/5"
                            ...
                            <div className="h-full pt-4 pb-safe overflow-y-auto overscroll-contain">
