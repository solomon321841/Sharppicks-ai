...
const tiers = [
    ...
    },
    {
        ...
        features: ['Everything in Pro', '500 Custom Builder Credits/Mo', 'Real-time Line Movement Alerts', 'Highest AI Confidence Picks', 'Priority Support', 'Early Access Features'],
        limitations: [],
        cta: 'Join Elite',
        popular: false,
    },
